...
const ExploreCart = ({ item }) => {
    return (
        <div className='p-6 w-[312px] bg-lightBlue rounded-lg '>
            ...
            <div className='font-manrope text-white space-y-4'>
                <div className='mt-6 flex items-center justify-between '>
                    <h3 className='text-xs opacity-[0.8]'><img className='w-3 h-3 inline-block mr-1' src={item.icon1} alt="" /> {item.title}</h3>
                    <button className='py-2 px-4 rounded-lg border border-pink font-semibold text-xs hover:bg-pink'>Buy  <img className='w-3 h-3 inline-block ml-2' src={item.icon2} alt="" /> </button>
                </div>

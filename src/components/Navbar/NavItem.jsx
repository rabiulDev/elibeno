    ...
    <div className="navItem relative group">
      <NavLink state={navItem.name} to={navItem.pathName}>
        <span className="hover:text-pink">
          {navItem.name}{" "}
          {navItem.dropDown && (
            <img className="inline" src={dropDownArrow} alt="" />
          )}
        </span>
        {navItem.dropDown && (
          <ul className="flex flex-col absolute top-7  py-4 px-4 w-[150px] bg-darkBlue invisible group-hover:visible hover:visible z-30 duration-200">
